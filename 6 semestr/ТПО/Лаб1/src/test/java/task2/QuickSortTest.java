...
public class QuickSortTest {
    ...
    @BeforeEach
    void clearTrace() {
        quickSort.getCrumbs().clearTrace();
    }
    ...
    void sort() {
        ...
        Assertions.assertEquals(quickSort.getCrumbs().getTrace(), "l0h8l0h2l0h-1l1h2l1h0l2h2l4h8l4h3l5h8l5h7l5h4l6h7l6h6l8h7l9h8", "Этап выполнения не совпадает");
    ...
    void negativeSort() {
        ...
        Assertions.assertEquals(quickSort.getCrumbs().getTrace(), "l0h8l0h4l0h2l0h0l2h2l4h4l6h8l6h5l7h8l7h7l9h8", "Этап выполнения не совпадает");
        Assertions.assertArrayEquals(arrSort, arr, "Массив отсортирован не верно");
    }
    ...
    void checkRepetitions() {
        ...
        quickSort.sort(arr, 0, arr.length - 1);
        Assertions.assertEquals(quickSort.getCrumbs().getTrace(), "l0h11l0h10l0h9l0h2l0h-1l1h2l1h0l2h2l4h9l4h3l5h9l5h7l5h4l6h7l6h5l7h7l9h9l11h10l12h11", "Этап выполнения не совпадает");
        Assertions.assertArrayEquals(arrSort, arr, "Массив отсортирован не верно");
    }
    ...
    void checkAlreadySortedTest() {
        ...
        int[] arrSort = {1, 2, 3, 4, 5, 6, 7, 8, 9};
        quickSort.sort(arr, 0, arr.length - 1);
        Assertions.assertEquals(quickSort.getCrumbs().getTrace(), "l0h8l0h7l0h6l0h5l0h4l0h3l0h2l0h1l0h0l2h1l3h2l4h3l5h4l6h5l7h6l8h7l9h8", "Этап выполнения не совпадает");
        Assertions.assertArrayEquals(arrSort, arr, "Массив отсортирован не верно");
    }
    ...
    void checkReversedTest() {
        ...
        int[] arrSort = {1, 2, 3, 4, 5, 6, 7, 8, 9};
        quickSort.sort(arr, 0, arr.length - 1);
        Assertions.assertEquals(quickSort.getCrumbs().getTrace(), "l0h8l0h-1l1h8l1h7l1h0l2h7l2h6l2h1l3h6l3h5l3h2l4h5l4h4l6h5l7h6l8h7l9h8", "Этап выполнения не совпадает");
        Assertions.assertArrayEquals(arrSort, arr, "Массив отсортирован не верно");
    }
    ...
    void partSortTest() {
        ...
        Assertions.assertEquals(quickSort.getCrumbs().getTrace(), "l4h8l4h4l6h8l6h6l8h8", "Этап выполнения не совпадает");
        Assertions.assertArrayEquals(arrSort, arr, "Массив отсортирован не верно");
    }
    ...
    void voidSortTest() {
        ...
        int[] arrSort = {};
        quickSort.sort(arr, 0, arr.length - 1);
        Assertions.assertEquals(quickSort.getCrumbs().getTrace(), "l0h-1", "Этап выполнения не совпадает");
        Assertions.assertArrayEquals(arrSort, arr, "Массив отсортирован не верно");
    }
