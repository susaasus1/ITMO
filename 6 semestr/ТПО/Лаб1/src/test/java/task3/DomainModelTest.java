...
public class DomainModelTest {
    ...
    public void childClimbTest() {
        ...
        Assertions.assertNull(kid.getGiveWhat(), "Малыш не может взять афишу, т.к он не на крыше!");
    ...
    @Test
    @DisplayName("Проверка количества клочков бумаги в зависимости от ее типа")
